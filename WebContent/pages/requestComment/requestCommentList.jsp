...
<script type="text/javascript">
	$(function() {
		...
		$("#btnAdd").click(function() {
			location.href = "${pageContext.request.contextPath}/requestComment/requestComment.wf";
		});
		...
		$('#dataGridId').datagrid({
			...
			onDblClickRow : function(rowIndex, rowData) {
				...
				var id = selectRow.id;
				location.href = "${pageContext.request.contextPath}/requestComment/requestComment.wf?id=" + id;
			}
		});
			...
			<table cellpadding="0" cellspacing="0" class="spe_table">
				<tr>
					...
					<td id="nameIdTd" style="text-align: left; height: 25px">
						<input class="spe_table_input" id="nameId" name="requestCommentName" placeholder=""
				...
				<table id="dataGridId"
					...
					<thead>
						<tr>
							...
							<th
								data-options="field:'requestFromUnit',halign:'center',width:120,formatter:function(value,row){
	                            return row.requestFromUnit.text;
	                        }">反馈单位</th>
							<th
								data-options="field:'latestFeedbackDate',halign:'center',width:120,
	                        ">最晚反馈时间</th>
						</tr>
					</thead>
					<tbody></tbody>
