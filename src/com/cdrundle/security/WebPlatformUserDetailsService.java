 ...
 */
public class WebPlatformUserDetailsService extends JdbcDaoSupport implements UserDetailsService {
    //~ Static fields/initializers =====================================================================================

    public static final String DEF_USERS_BY_USERNAME_QUERY =
            "select username,password,enabled,orgID,realName " +
            "from users " +
            "where username = ?";
    ...
    public WebPlatformUserDetailsService() {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException, DataAccessException {
        ...
        WebPlatformUser user = (WebPlatformUser)users.get(0); // contains no GrantedAuthority[]
    ...
    protected List<UserDetails> loadUsersByUsername(String username) {
        return getJdbcTemplate().query(usersByUsernameQuery, new String[] {username}, new RowMapper<UserDetails>() {
            public UserDetails mapRow(ResultSet rs, int rowNum) throws SQLException {
                ...
                return new WebPlatformUser(userId,username, password, enabled,orgId,orgName,realName,email, true, true, true, AuthorityUtils.NO_AUTHORITIES);
            }
     ...
     */
    protected WebPlatformUser createUserDetails(String username, WebPlatformUser userFromUserQuery,
        ...
        return new WebPlatformUser(userFromUserQuery.getUserId(),returnUsername, userFromUserQuery.getPassword(), userFromUserQuery.isEnabled(),userFromUserQuery.getOrgId(),userFromUserQuery.getOrgName(),userFromUserQuery.getRealName(),userFromUserQuery.getEmail(),
