...
<script type="text/javascript">
	$(function() {
		...
		$("#btnAdd")
				.click(
						function() {
							location.href = "${pageContext.request.contextPath}/modifyDraft/modifyDraft.wf";
						});
		...
		$('#dataGridId').datagrid({
			...
			onDblClickRow: function (rowIndex, rowData) {
				$('#dataGridId').datagrid('selectRow',rowIndex);
				  ...
				  var id=selectRow.id;
				  location.href = "${pageContext.request.contextPath}/modifyDraft/modifyDraft.wf?id="+id;
			}
		});
	});
</script>
			...
			<table cellpadding="0" cellspacing="0" class="spe_table">
				<tr>
					...
					<td id="nameIdTd" style="text-align: left; height: 25px">
						<input class="spe_table_input" id="nameId" name="modifyDraftName" placeholder=""
