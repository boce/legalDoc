...
<script type="text/javascript">
	$(function() {
		...
		$("#btnAdd").click(function(){
			location.href = "${pageContext.request.contextPath}/examDraft/examDraftSubmit.wf";
		});
		$('#sStatus').combobox({
		...
		$('#dataGrid').datagrid({
			...
			onDblClickRow: function (rowIndex, rowData) {
				...
				var id=selectRow.id;
				location.href = "${pageContext.request.contextPath}/examDraft/examDraftSubmit.wf?id="+id;
			}
		});
	...
	<div data-options="region:'center', split:true">
		<div id="cc" class="easyui-layout" style="width: 1200px; height: 733px;">
				...
				<tr>
					...
					<td id="examSubNameTd" style="text-align: left; height: 20px">
						<input id="examSubName" class="spe_table_input" placeholder=""
							...
							style="margin: 1px; border: 0px none;" />
					</td>
			...
			<div id="dataDivWindow" style="height:500px;overflow-y: auto;overflow-x: hidden;">
				<table id="dataGrid" data-options="fitColumns:true,singleSelect:true, pagination:true,rownumbers:true,height:306,border:0">
					<thead>
						<tr>
							...
							<th data-options="field:'unionDraftingUnit',halign:'center',width:120,formatter:function(value,row){return row.normativeFile.unionDrtUnitName;}">联合起草单位</th>
