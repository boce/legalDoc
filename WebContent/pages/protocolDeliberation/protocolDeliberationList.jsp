...
<script type="text/javascript">
	$(function() {
		...
		$("#btnAdd").click(function() {
			location.href = "${pageContext.request.contextPath}/ProtocolDeliberation/protocolDeliberation.wf";
		});
		...
		$('#dataGridId').datagrid({
			...
			onDblClickRow: function (rowIndex, rowData) {
				$('#dataGridId').datagrid('selectRow',rowIndex);
				  ...
				  var id=selectRow.id;
				  location.href = "${pageContext.request.contextPath}/ProtocolDeliberation/protocolDeliberation.wf?id="+id;
			}
		});
	});
</script>
...
<body>
	<div data-options="region:'center', split:true">
		<div id="cc" class="easyui-layout"
			style="width: 1200px; height: 733px;">
			...
			<table cellpadding="0" cellspacing="0" class="spe_table">
				<tr>
					...
					<td id="nameIdTd" style="text-align: left; height: 20px">
						<input class="spe_table_input" id="nameId" name="protocolDeliberationName" placeholder=""
