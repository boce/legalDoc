...
<script type="text/javascript">
	$(function() {
		...
		$("#btnAdd").click(function() {
			location.href = "${pageContext.request.contextPath}/feedbackComment/feedbackComment.wf";
		});
		...
		$('#dataGridId').datagrid({
			...
			onDblClickRow : function(rowIndex, rowData) {
				...
				var id = selectRow.id;
				location.href = "${pageContext.request.contextPath}/feedbackComment/feedbackComment.wf?id=" + id;
			}
		});
	});
	...
	<div data-options="region:'center', split:true">
		<div id="cc" class="easyui-layout" style="width: 1200px; height: 733px;">
			...
			<table cellpadding="0" cellspacing="0" class="spe_table">
				<tr>
					...
					<td id="nameIdTd" style="text-align: left; height: 25px">
						<input class="spe_table_input" id="nameId" name="feedbackCommentName" placeholder=""
			...
			<div id="dataDivWindow" style="height:500px;overflow-y: auto;overflow-x: hidden;">
				<table id="dataGridId"
					data-options="fitColumns:true,singleSelect:true,pagination:true,rownumbers:true,height:306,border:0">
					<thead>
						<tr>
							<th data-options="field:'id',halign:'center',hidden:true,">id</th>
							<th data-options="field:'name',halign:'center',width:638">文件名称</th>
							<th
								data-options="field:'draftingUnit',halign:'center',width:120,formatter:function(value,row){
	                            return row.draftingUnit.text;
	                        }">起草单位</th>
							<th
								data-options="field:'feedbackUnit',halign:'center',width:120,formatter:function(value,row){
	                            return row.feedbackUnit.text;
	                        }">反馈单位</th>
							<th
								data-options="field:'actualFeedbackDate',halign:'center',width:120,
	                        ">反馈时间</th>
						</tr>
					</thead>
					<tbody></tbody>
