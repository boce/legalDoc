...
<script type="text/javascript">
	$(function() {
		...
		$("#btnAdd").click(
						function() {
							location.href = "${pageContext.request.contextPath}/signAndPublish/signAndPublish.wf";
						});
		...
		$('#dataGridId').datagrid({
				...
				$('#dataGridId').datagrid('selectRow',rowIndex);
				  ...
				  var id=selectRow.id;
				  location.href = "${pageContext.request.contextPath}/signAndPublish/signAndPublish.wf?id="+id;
			}
		});
	});
</script>
			...
			<table cellpadding="0" cellspacing="0" class="spe_table">
				<tr>
					...
					<td id="nameIdTd" style="text-align: left; height: 25px">
						<input id="nameId" class="spe_table_input" name="signAndPublishName" placeholder=""
