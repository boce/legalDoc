...
<script type="text/javascript">
	$(function() {
		...
		$("#btnAdd")
				.click(
						function() {
							location.href = "${pageContext.request.contextPath}/developApplication/developApplication.wf";
						});
		...
		$('#dataGridId').datagrid({
			...
			onDblClickRow: function (rowIndex, rowData) {
				$('#dataGridId').datagrid('selectRow',rowIndex);
				  ...
				  var id = selectRow.id;
				  location.href = "${pageContext.request.contextPath}/developApplication/developApplication.wf?id="+id;
			}
		});
	});
</script>
			...
			<table cellpadding="0" cellspacing="0" class="spe_table">
				<tr>
					...
					<td id="nameIdTd" style="text-align: left; height: 25px">
						<input class="spe_table_input" id="nameId" name="developAppName" placeholder=""
				...
				<table id="dataGridId" data-options="fitColumns:true,singleSelect:true,pagination:true,rownumbers:true,height:306,border:0">
					<thead>
						<tr>
							...
							<th
								data-options="field:'applyOrg',halign:'center',width:120,formatter:function(value,row){
	                            return row.applyOrg.text;
	                        }">申报单位</th>
						</tr>
					</thead>
					<tbody></tbody>
